...
public class StudentAction extends ActionSupport{
	...
	//Map<String, Object> session = (Map) ActionContext.getContext().get("session");
		StudentDetails sd=new StudentDetails(Integer.parseInt(userid), mailid,Double.parseDouble(phoneno), username1, password);
	...
	public String enroll(){
		...
		StudentDetails sd=new StudentDetails(Integer.parseInt(hiddenValue1),hiddenValue2,subject);
		if(subject.equals("-1")){
	...
	public String drop(){
		...
		if("no".equalsIgnoreCase(cd1.getCheck())){
				...
				Map<String, Object> context = new HashMap<String, Object>();
	            context.put("Msg1", new String("you have dropped the "+cd1.getCourse_name())); 
